"""
Django settings for dem_api project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-4vf991oij7wlzd84cj(-i6+xgyz(7&(1yq12m$kod#1ynhd7gt')
...
WSGI_APPLICATION = 'dem_api.wsgi.application'
...
STATIC_URL = 'static/'
# Este bloco só será executado em produção (quando DEBUG=False)
if not DEBUG:
    # Diretório para onde o `collectstatic` irá copiar os arquivos estáticos para o deploy
